...
- Parent it under today's Daily Journal page (`Daily YYYY-MM-DD`, database `2edf3995-0a22-80df-8e22-000b259ac157`). Find that day's page; if it does not exist yet, create it in that database with Title `Daily YYYY-MM-DD` and the Date property set (the journal convention is one page per day), note in the briefing that you created it, and leave Mood/Gratitude/body alone.
